  ...
  sample() async {
    ...
    bluetooth.isConnected.then((isConnected) {
      if (isConnected == true) {
        ...
        bluetooth.printNewLine();
        bluetooth.printCustom("مرحبا", Size.boldMedium.val, Align.center.val);
        bluetooth.printCustom("الشعر العربي لم يكن مجرد كلامٍ عابرٍ يقال، إنّه عالمٌ بحدّ ذاته،",Size.medium.val,Align.center.val);
        bluetooth.printLeftRight("مرحبا", "مرحبا", Size.bold.val);
        bluetooth.printNewLine();
        bluetooth.printNewLine();
        bluetooth.printNewLine();
        bluetooth.printNewLine();
